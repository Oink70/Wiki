...
[Verus Wallet installation guide (Linux)](#!faq-linux/faq-lin01_install_linux_cli.md) ***`UPDATED`***
...
**[Install the Linux CLI wallet](#!faq-linux/faq-lin01_install_linux_cli.md)** ***`UPDATED`***
...
Note: last revision date 2020-06-26.
