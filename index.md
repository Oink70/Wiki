...
[Verusd options list](#!faq-cli/clifaq-01_verusd_options.md) ***`UPDATED to v1.2.0-1`***
[Verus command list](#!faq-cli/clifaq-02_verus_commands.md) ***`UPDATED to v1.2.0-1`***
[Remarks on Windows command line formatting](#!faq-windows/winfaq-01_cli_formatting.md)
...
Note: last revision date 2024-04-07.
